...
const envSchema = z.object({
  ...
  EXPO_PUBLIC_IGDB_CLIENT_ID: z.string(),
  EXPO_PUBLIC_IGDB_CLIENT_SECRET: z.string(),
...
const BUNDLE_IDS = {
  development: 'com.gamory.development',
  preview: 'com.gamory.preview',
  production: 'com.gamory',
} as const;
...
const _env: z.infer<typeof envSchema> = {
  ...
  EXPO_PUBLIC_IGDB_CLIENT_SECRET: process.env.EXPO_PUBLIC_IGDB_CLIENT_SECRET ?? '',
